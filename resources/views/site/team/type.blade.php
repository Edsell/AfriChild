...
{{-- TEAM TYPE PAGE (same look as About TEAM SECTION) --}}
<section id="about-team" class="vc_row wpb_row vc_row-fluid vc-zozo-section typo-default" style="padding: 55px 0; background:#fafafa;">
    ...
    <div class="container">
      ...
      <div class="ac-team-group" style="margin-top: 34px;">
        ...
        @else
          ...
          @if($isPeople)
            {{-- PEOPLE GRID (same as About for Board/Secretariat) --}}
          ...
          @else
            {{-- PARTNERS GRID (same as About for partners) --}}
  ...
  {{-- SAME INLINE STYLES from About TEAM SECTION --}}
  <style>
