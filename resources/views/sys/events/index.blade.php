...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card mb-3">
    <div class="card-body">
      <form class="row g-2">
        <div class="col-md-5">
          <input type="text" name="search" value="{{ request('search') }}" class="form-control" placeholder="Search title, venue, location">
        </div>
        <div class="col-md-3">
            ...
            <tr>
              <td>
                <div class="d-flex align-items-center gap-2">
                  <img src="{{ $event->image_url }}" class="rounded" style="width:44px;height:44px;object-fit:cover" alt="">
                  <div>
              ...
              <td class="text-end">
                <a href="{{ route('sys.events.edit',$event) }}" class="btn btn-sm btn-outline-primary">Edit</a>
                <form action="{{ route('sys.events.destroy',$event) }}" method="POST" class="d-inline"
